...
@Controller
public class TotalSeotdaController {

	@RequestMapping(value = "/totaldobak")
	public String getDeck(HttpServletRequest req, Model model) {
		...
		int totalHanded = (cd.getCards().get(0).getNum() + cd.getCards().get(2).getNum()) % 10;
		String result = "";
